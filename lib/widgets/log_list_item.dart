...
class LogListItem extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _monoTag(log.keyName.isNotEmpty ? log.keyName : log.provider, resolved: Provider.of<AppState>(context, listen: false).getProvider(log.provider)?.name),
  ...
  Widget _monoTag(String text, {String? resolved}) {
    return Container(
