...
class UserSettings {
  ...
  int quotaCooldownMinutes; // Key 被标记「额度耗尽」后的冷却时长（分钟）
  ...
  UserSettings({
    ...
    this.quotaCooldownMinutes = Constants.defaultQuotaCooldownMinutes,
  ...
  factory UserSettings.fromJson(Map<String, dynamic> json) {
    return UserSettings(
      ...
      quotaCooldownMinutes: json['quota_cooldown_minutes'] as int? ??
          Constants.defaultQuotaCooldownMinutes,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'quota_cooldown_minutes': quotaCooldownMinutes,
  ...
  UserSettings copyWith({
    ...
    return UserSettings(
      ...
      quotaCooldownMinutes: quotaCooldownMinutes ?? this.quotaCooldownMinutes,
