...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  late int _quotaCooldownSeconds;
  ...
  void initState() {
    ...
    _quotaCooldownSeconds = s.quotaCooldownSeconds;
  ...
  Future<void> _save(AppState app) async {
    final newSettings = app.settings.copyWith(
      ...
      quotaCooldownSeconds: _quotaCooldownSeconds,
          ...
          _card(context, [
            ...
            _numberRow(
              ...
              onTap: () => _editNumber(
                ...
                unit: L10n.tr('秒'),
                onSaved: (v) {
                  setState(() => _quotaCooldownSeconds = v);
                  _save(app);
                },
              ),
            ),
