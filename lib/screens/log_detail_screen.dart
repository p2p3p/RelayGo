...
class LogDetailScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _section(L10n.tr('路由'), [
            _kv('服务商', log.provider, resolved: Provider.of<AppState>(context, listen: false).getProvider(log.provider)?.name),
  ...
  Widget _kv(String label, String value, {bool mono = false, bool wrap = false, String? resolved}) {
    return Padding(
