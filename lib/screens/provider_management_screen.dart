    ...
    return Card(
      ...
      child: ListTile(
        leading: CircleAvatar(
          backgroundColor:
              provider.builtIn ? Colors.indigo.withValues(alpha: 0.15) : Colors.teal.withValues(alpha: 0.15),
          child: Icon(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: provider.builtIn ? Colors.grey.withValues(alpha: 0.15) : Colors.teal.withValues(alpha: 0.15),
