      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<String>(
            ...
            tooltip: t.t('导出'),
            onSelected: (kind) => _export(context, kind),
            itemBuilder: (_) => [
              PopupMenuItem(value: 'json', child: Text(t.t('导出 JSON'))),
              PopupMenuItem(value: 'csv', child: Text(t.t('导出 CSV'))),
              PopupMenuItem(value: 'md', child: Text(t.t('导出 Markdown'))),
            ],
          ),
        ],
      ),
