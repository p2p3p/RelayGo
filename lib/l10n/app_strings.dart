...
class L10n {
  ...
  static const Map<String, String> _en = {
    ...
    '每日额度不能为空': 'Daily quota cannot be empty',
    '额度必须为非负整数': 'Quota must be a non-negative integer',
    '(自定义)': '(custom)',
    ...
    // ===== 模型同步进度 =====
    '选择同步提供商': 'Select providers to sync',
    '全部拉取': 'Fetch all',
    '同步（{n}）': 'Sync ({n})',
    '没有可用 Key，请先添加或启用 Key':
        'No available keys. Please add or enable a key first.',
    '同步模型': 'Sync Models',
